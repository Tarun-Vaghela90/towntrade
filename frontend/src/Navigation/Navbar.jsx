          ...
          {isLoggedIn ? (
            <>
              ...
              {accountStatus === "active" && (
                <ProductModal buttonName={"Sell"} title={"Sell Product"} />
              )}
          ...
          >
            ...
            {noti.timestamp && (
              ...
              {currentUser?.user?.role === "user" && (
                <AlertConfirm
                  triggerText="Premium"
                  title="Became  Premium User"
                  description="You  Will Have  Option To Feature  Product"
                  confirmText="Upgrade"
                  cancelText="Cancel"
                  onConfirm={() => upgradePremium()}
                    ...
                    <NavigationMenuContent className="p-4 min-w-[178px]  ">
                      <ul className="space-y-2">
                        ...
                        <li className="flex items-center gap-2">
                          ...
                          <Link to={"/collection"}>
                            <NavigationMenuLink>Saved Items</NavigationMenuLink>
                          </Link>
                        </li>

                        <li className="flex items-center gap-2">
                          <ShoppingCart className="w-5 h-5" />
                          <Link to="/userSoldProducts">Selling Products</Link>
                        </li>
                        <li className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col gap-4 mt-4 border-t pt-4">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <Link
                          ...
                          className="text-gray-700 flex items-center gap-2"
                        >
                          <ShoppingCart className="w-5 h-5" /> Selling Products
                        </Link>
